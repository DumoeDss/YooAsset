...
namespace YooAsset
{
	public static partial class YooAssets
	{
		...
		public static ResourcePackage CreatePackage(string packageName, string packageVersion)
		{
			if (_isInitialize == false)
			...
			ResourcePackage package = new ResourcePackage(packageName, packageVersion);
